          ...
          <div className="flex flex-col items-center text-center space-y-8 py-20">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
                ...
                <br />
                <span className="font-sans">For Modern Web</span>
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl max-w-2xl font-sans font-bold text-neutral-100"
            >
              Designed and developed by our team these high-quality, 
              interactive, and fully responsive components are ready to copy and paste seamlessly into your project or install via the Shadcn CLI.
            </motion.p>
